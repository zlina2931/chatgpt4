    ...
    <div class="flex h-full">
      <div class="flex flex-col w-full max-w-md mx-8 sm:mx-18">
        ...
        <Show when={props.isLogin()}>
          ...
          <a href="https://jyallimg.s3.ap-northeast-1.amazonaws.com/vision/2023-12-12/17023955647147312.jpg?versionId=lhZcxxfOdK1eeHj7aJqwkfknVwNFx7yZ" target="_blank" class="fi gap-2 h-8 text-sm op-60  text-yellow-500" rel="noreferrer">加群防失联</a>
