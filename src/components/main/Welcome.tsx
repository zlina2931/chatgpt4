    ...
    <div class="flex h-full">
      <div class="flex flex-col w-full max-w-md mx-8 sm:mx-18">
        ...
        <Show when={props.isLogin()}>
          ...
          <a href="https://filesread.mwdevname.com/mc_shop/2023121900110399430.jpg" target="_blank" class="fi gap-2 h-8 text-sm op-60  text-yellow-500" rel="noreferrer">加群防失联</a>
