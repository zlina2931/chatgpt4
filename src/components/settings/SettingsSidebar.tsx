    ...
    <div class="h-full flex flex-col bg-sidebar">
      ...
      <footer class="h-14 fi justify-between px-3">
        ...
        <div text-xs op-40 px-2>
          <a href="https://jyallimg.s3.ap-northeast-1.amazonaws.com/vision/2023-11-23/1700721544890363.jpg?versionId=SCOVW9AVevTv_MV7XfZPaZ3Kcms20kAk" target="_blank" rel="noreferrer" class="hv-foreground">
            加群防失联
          </a>
